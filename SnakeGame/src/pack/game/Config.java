...
public class Config {
	...
	// Display config
	public static int displayWidth  = 600; public static final String displayWidthPrefix  = "display_width";
	public static int displayHeight = 600; public static final String displayHeightPrefix = "display_height";
